...
const homePillarsSummary = [
    { title: 'THINK', tagline: 'We architect brand strategy, positioning, and go-to-market frameworks that drive clarity, decisive action, and long-term competitive advantage.', link: '/services#think' },
    { title: 'CREATE', tagline: 'We build integrated design systems, campaigns, scalable AI solutions, and visual assets for ambitious brands who refuse to be ordinary.', link: '/services#create' },
    { title: 'INFLUENCE', tagline: 'We deploy performance-driven digital marketing, SEO, paid media, and analytics ecosystems optimized for measurable ROI and sustained growth.', link: '/services#influence' },
    { title: 'EXPERIENCE', tagline: 'We build connected ecosystems to create immersive brand experiences that drive engagement and measurable impact across every touchpoint.', link: '/services#experience' }
];
...
export const Home: React.FC = () => {
    ...
    return (
        <div className="flex flex-col">
            ...
            {missionSection && (
                <AnimatedSection className="text-center bg-brand-charcoal/50 !py-20">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-brand-peach tracking-tight font-sans uppercase">{missionSection.title}</h2>
                        <p className="text-lg md:text-xl text-text-muted leading-relaxed font-serif">{missionSection.content}</p>
                    </div>
                </AnimatedSection>
            )}
            ...
            <AnimatedSection>
                <h2 className="text-3xl md:text-4xl font-bold text-brand-blue-light tracking-tight mb-4 font-sans uppercase">The Full Marketing Spectrum</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-6 max-w-7xl mx-auto">
                    {homePillarsSummary.map((pillar, idx) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`relative rounded-2xl border ${colors.border} ${colors.hoverBorder} bg-surface/50 p-8 h-full flex flex-col items-center text-center transition-all duration-500 hover:shadow-2xl ${colors.glow} overflow-hidden cursor-pointer`}>
                                    ...
                                    <div className="relative z-10 flex flex-col items-center h-full">
                                        ...
                                        <p className="text-text-muted text-sm leading-relaxed flex-grow">{pillar.tagline}</p>
                                        <NavLink
                                            to={pillar.link}
            ...
            <AnimatedSection className="bg-brand-charcoal/30 !py-20">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-brand-offwhite tracking-tight mb-4 font-sans uppercase">One-Stop Hub for Brand, Marketing & Growth</h2>
                    <p className="text-lg text-text-muted max-w-3xl mx-auto font-serif">We are a collective of sharp thinkers and creative makers delivering scalable, strategic solutions that redefine how brands think, communicate, and influence.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {content.differentiators.map((diff, idx) => (
                        <motion.div
                            ...
                            className="group p-8 rounded-2xl bg-surface/60 border border-white/5 hover:border-brand-blue/30 transition-all duration-300 hover:shadow-lg hover:shadow-brand-blue/5"
                        >
            ...
            {content.caseStudies.length > 0 && (
                <AnimatedSection>
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-brand-peach tracking-tight mb-4 font-sans uppercase">Trusted By Ambitious Brands & Global Leaders</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {content.caseStudies.map((cs, idx) => (
                            <motion.div
                                ...
                                className="p-8 rounded-2xl bg-surface border border-white/5 hover:border-brand-blue/30 transition-all group"
                            >
            ...
            <AnimatedSection className="text-center !py-24">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-brand-offwhite tracking-tight mb-6 font-sans uppercase">Ready To Make Your Brand Inevitable?</h2>
                    <p className="text-xl text-text-muted mb-10 font-serif">Let's Make It Happen!</p>
