        ...
        <div className="pt-24">
            <div className="px-5 py-5">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="mt-4 text-brand-peach/80 font-serif">Last Updated: March 2026</p>
                </div>
            </div>
            ...
            <AnimatedSection className="max-w-4xl mx-auto px-5 py-12">
                <div className="prose prose-invert prose-brand max-w-none">
                    ...
                    <p className="text-brand-silver/90 font-serif leading-relaxed mb-6">
                    ...
                    <p className="text-brand-silver/90 font-serif leading-relaxed">
